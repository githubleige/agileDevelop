 ...
 * @since [产品/模块版本] （可选）
 */
@WorkflowNode(nodeCode = WorkflowConstant.WORKFLOW_NODE_CODE_EOPF)
@Component
public class EopfNodeExecutable implements IWorkflowNodeExecutable {

    private static final long serialVersionUID = -7785558166935320288L;
